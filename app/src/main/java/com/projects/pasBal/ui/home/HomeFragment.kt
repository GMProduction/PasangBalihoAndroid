...
import com.projects.pasBal.ui.adapter.AdapterSlider
...
import com.projects.pasBal.utils.firebaseServices.MyFirebaseMessagingService.Companion.NOTIF_TRANSAKSI
...
//        }
    ...
    override fun onTimeOut(s: String) {
        ...
        Coroutines.main {
            ...
            reload.visibility = View.VISIBLE
            scroller.visibility = View.VISIBLE
            dialogHandler(activity!!, "Time Out", ERROR_INTERNET, R.drawable.ic_nointernet, "pesan")
        }
    }
