...
import com.genossys.pasangbaliho.data.db.entity.News
import com.genossys.pasangbaliho.ui.adapter.AdapterNews
...
class NewsFragment : CommonListener, KodeinAware, Fragment() {
