...
import com.genossys.pasangbaliho.ui.adapter.AdapterTransaksi
import com.genossys.pasangbaliho.ui.home.MenuTransaksiViewModel
import com.genossys.pasangbaliho.ui.home.MenuTransaksiViewModelFactory
 ...
 */
class MenuTransaksiFragment(private val isi: String) : Fragment(), KodeinAware, CommonListener {
            ...
            try {
                Coroutines.main {
                    viewModel.getDataTransaksi(
                        idPref?.getInt(SplashScreen.ID_ADVERTISER, 0)!!,
                        isi,
                        page
                    )
    ...
    override fun onFailure(message: String) {
        ...
        Coroutines.main {
            ...
            root.snackbarError("koneksi error, mohon cek koneksi anda!")
        }
    }
